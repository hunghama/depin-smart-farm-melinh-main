...
class ProvenanceRecord(BaseModel):
    """Màng bảo vệ cấu trúc chứng chỉ VietGAP số."""
...
# -------------------------------------------------------------
# CORE LOGIC: HỘP XÁM TỰ ĐỘNG SINH DẤU CHÂN SỐ & DỆT CHỨNG CHỈ SỐ
# -------------------------------------------------------------
class ProvenanceEngine:
    ...
    def build_provenance_footprint(self, crop: str, stage: str, weather_text: str, ai_text: str) -> ProvenanceRecord:
        """Tự động gom dữ liệu thời gian thực để dệt thành chứng chỉ số."""
    ...
    # =====================================================================
    # 🔥 THỰC THI MODULE SÂU: KHÉO LÉO GIẤU CHẶT TOÀN BỘ LOGIC DIỆN MẠO HTML
    # =====================================================================
    def render_html_certificate(self, record_id: str, record: dict | None) -> str:
        """
        Đóng hòm toàn bộ logic trình diễn giao diện vào tầng lõi sâu.
        Tránh rò rỉ mã HTML thô ra ngoài file cấu hình router main.py.
        """
        ...
        # 🟩 KỊCH BẢN THÀNH CÔNG: Dệt chứng chỉ xanh tươi bảo chứng nông sản
            ...
            <div class="w-full max-w-lg bg-slate-900 border border-slate-800 rounded-3xl shadow-2xl overflow-hidden">
                ...
                <div class="p-6 space-y-5">
                    ...
                    <div class="border-t border-slate-800/80 pt-4 text-center">
                        ...
                        <p class="text-[9px] text-slate-500 mt-2">Dữ liệu đã khóa chết trên MongoDB Cloud. Phát hiện gian lận nếu sai một ký tự.</p>
                    </div>
                </div>
